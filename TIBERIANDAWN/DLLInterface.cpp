...
bool Debug_Write_Shape(const char* file_name, void const* shapefile, int shapenum, int flags = 0,
...
{
	IN_NOVAR,
	// No variation or alterations allowed.
	IN_JUV,
	// Juvenile sound effect alternate option.
	IN_VAR,
	// Infantry variance response modification.
};
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Start_Instance(int scenario_index, int build_level,
                                                                 const char* faction, const char* game_type,
                                                                 const char* content_directory, int sabotaged_structure,
                                                                 const char* override_map_name);
extern "C" __declspec(dllexport) bool __cdecl CNC_Start_Instance_Variation(
	int scenario_index, int scenario_variation, int scenario_direction, int build_level, const char* faction,
	const char* game_type, const char* content_directory, int sabotaged_structure, const char* override_map_name);
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Get_Game_State(GameStateRequestEnum state_type, uint64 player_id,
                                                                 unsigned char* buffer_in, unsigned int buffer_size);
extern "C" __declspec(dllexport) bool __cdecl CNC_Read_INI(int scenario_index, int scenario_variation,
                                                           int scenario_direction, const char* content_directory,
                                                           const char* override_map_name, char* ini_buffer,
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Game_Settings_Request(
	int health_bar_display_mode, int resource_bar_display_mode);
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Input(InputRequestEnum mouse_event,
                                                               unsigned char special_key_flags, uint64 player_id,
                                                               int x1, int y1, int x2, int y2);
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Structure_Request(
	StructureRequestEnum request_type, uint64 player_id, int object_id);
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Sidebar_Request(
	SidebarRequestEnum request_type, uint64 player_id, int buildable_type, int buildable_id, short cell_x,
	short cell_y);
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_SuperWeapon_Request(
	SuperWeaponRequestEnum request_type, uint64 player_id, int buildable_type, int buildable_id, int x1, int y1);
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_ControlGroup_Request(
	ControlGroupRequestEnum request_type, uint64 player_id, unsigned char control_group_index);
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Debug_Request(DebugRequestEnum debug_request_type,
                                                                       uint64 player_id, const char* object_name, int x,
                                                                       int y, bool unshroud, bool enemy);
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Select_Object(uint64 player_id, int object_type_id,
...
public:
	...
	static void DLL_Draw_Intercept(int shape_number, int x, int y, int width, int height, int flags,
	                               ObjectClass* object, const char* shape_file_name = NULL,
	                               char override_owner = HOUSE_NONE, int scale = 0x100);
	...
	static bool Construction_Action(SidebarRequestEnum construction_action, uint64 player_id, int buildable_type,
	                                int buildable_id);
	static bool MP_Construction_Action(SidebarRequestEnum construction_action, uint64 player_id, int buildable_type,
	                                   int buildable_id);
	static bool Passes_Proximity_Check(CELL cell_in, BuildingTypeClass* placement_type,
	...
	static void Cell_Class_Draw_It(CNCDynamicMapStruct* dynamic_map, int& entry_index, CellClass* cell_ptr, int xpixel,
	                               int ypixel, bool debug_output);
	...
	static void On_Sound_Effect(const HouseClass* player_ptr, int sound_effect_index, const char* extension,
	                            int variation, COORDINATE coord);
	...
	static void On_Message(const HouseClass* player_ptr, const char* message, float timeout_seconds,
	                       EventCallbackMessageEnum message_type, int64 message_id);

	static void On_Debug_Output(const char* debug_text);

	static void On_Achievement(const HouseClass* player_ptr, const char* achievement_type,
...
private:
	...
	static unsigned int TD_Calculate_Efficiency(unsigned int harvested_credits, unsigned int initial_credits,
...
extern "C" __declspec(dllexport) void __cdecl CNC_Add_Mod_Path(const char* mod_path)
{
	// DotNetApiVc::DebugBox("CNC_Add_Mod_Path: ");
	// DotNetApiVc::DebugBox(mod_path);
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Get_Visible_Page(unsigned char* buffer_in, unsigned int& width,
                                                                   unsigned int& height)
{
	// DotNetApiVc::DebugBox("CNC_Get_Visible_Page: ");
	//
	// if (buffer_in == nullptr)
	//     DotNetApiVc::DebugBox("null");
	// else
	//     DotNetApiVc::DebugBox("notnullptr");
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Get_Palette(unsigned char (&palette_in)[256][3])
{
	// DotNetApiVc::DebugBox("CNC_Get_Palette");
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Clear_Object_Selection(uint64 player_id)
{
	// DotNetApiVc::DebugBox("CNC_Clear_Object_Selection");
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Select_Object(uint64 player_id, int object_type_id,
                                                                int object_to_select_id)
{
	// DotNetApiVc::DebugBox("CNC_Select_Object");
...
void GlyphX_Assign_Houses(void)
{
	...
	bool color_used[16];
	// true = this color is in use. We have more than 6 color options now, so bumped this to 16. ST - 6/19/2019 5:18PM
	bool preassigned;
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Start_Instance(int scenario_index, int build_level,
                                                                 ...
                                                                 const char* override_map_name)
{
	// DotNetApiVc::DebugBox("CNC_Start_Instance");
	return CNC_Start_Instance_Variation(scenario_index, (int)SCEN_VAR_NONE, (int)SCEN_DIR_EAST, build_level, faction,
	                                    game_type, content_directory, sabotaged_structure, override_map_name);
}
...
void HandleSabotagedStructure(int structure_type)
{
	...
	if (SabotagedType != STRUCT_NONE && Scenario == 7 && PlayerPtr->Class->House == HOUSE_GOOD)
	{
		for (index = 0; index < Buildings.Count(); index++)
		{
			...
			if (building && !building->IsInLimbo && building->House != PlayerPtr && building->Class->Type ==
				SabotagedType)
			{
				building->Limbo();
				delete building;
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Read_INI(int scenario_index, int scenario_variation,
                                                           ...
                                                           int _ini_buffer_size)
{
	// DotNetApiVc::DebugBox("CNC_Read_INI");
	...
	{
		Set_Scenario_Name(ScenarioName, Scenario, ScenPlayer, (ScenarioDirType)scenario_direction,
...
extern "C" __declspec(dllexport) void __cdecl CNC_Set_Home_Cell(int x, int y, uint64 player_id)
{
	//    DotNetApiVc::DebugBox("CNC_Set_Home_Cell");
	//    DotNetApiVc::DebugBox(x);
	// DotNetApiVc::DebugBox(y);
	// DotNetApiVc::DebugBox(player_id);
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Start_Instance_Variation(
	...
	const char* game_type, const char* content_directory, int sabotaged_structure, const char* override_map_name)
{
	// DotNetApiVc::DebugBox("CNC_Start_Instance_Variation");
...
bool Debug_Write_Shape(const char* file_name, void const* shapefile, int shapenum, int flags, void const* ghostdata)
{
	...
	*/
	...
	if (flags == 0)
	{
		Buffer_Frame_To_Page(0, 0, width, height, shape_pointer, temp_viewport,
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Advance_Instance(uint64 player_id)
{
	// DotNetApiVc::DebugBox("CNC_Advance_Instance");
	// DotNetApiVc::DebugBox((int)player_id);

	//DLLExportClass::Set_Event_Callback(event_callback);

	DotNetApiVc::MainLoop();
		
	InMainLoop = true;

	if (Frame <= 10)
	{
		// Don't spam forever, but useful to know that we actually started advancing
...
extern "C" __declspec(dllexport) void __cdecl CNC_Set_Difficulty(int difficulty)
{
	// DotNetApiVc::DebugBox("CNC_Set_Difficulty");
...
{
	// DotNetApiVc::DebugBox("CNC_Handle_Human_Team_Wins");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Start_Mission_Timer(int time)
{
	// DotNetApiVc::DebugBox("CNC_Start_Mission_Timer");
...
**************************************************************************************************/
void DLLExportClass::On_Sound_Effect(const HouseClass* player_ptr, int sound_effect_index, const char* extension,
                                     int variation, COORDINATE coord)
{
	...
	{
		strncpy(new_event.SoundEffect.SoundEffectName, SoundEffectName[sound_effect_index].Name,
		        CNC_OBJECT_ASSET_NAME_LENGTH);
		new_event.SoundEffect.SoundEffectName[CNC_OBJECT_ASSET_NAME_LENGTH - 1] = 0;
		// strncpy can leave strings unterminated		
		if (extension != NULL)
		{
			strncat(new_event.SoundEffect.SoundEffectName, extension, CNC_OBJECT_ASSET_NAME_LENGTH);
			new_event.SoundEffect.SoundEffectName[CNC_OBJECT_ASSET_NAME_LENGTH - 1] = 0;
			// strncat can leave strings unterminated
		}
...
**************************************************************************************************/
unsigned int DLLExportClass::TD_Calculate_Efficiency(unsigned int harvested_credits, unsigned int initial_credits,
                                                     unsigned int available_credits)
{
...
* History: 10.29.2019 MBL (Based on LLL's Calculate_Single_Player_Score())
**************************************************************************************************/
unsigned int DLLExportClass::TD_Calculate_Score(unsigned int leadership, unsigned int efficiency,
...
void DLLExportClass::Calculate_Single_Player_Score(EventCallbackStruct& event)
{
	...
	// }
	//
	unsigned leadership = TD_Calculate_Leadership(house, (house == HOUSE_GOOD ? gdi_units_lost : nod_units_lost),
	...
	*/
	...
	// }
	//
	unsigned efficiency = TD_Calculate_Efficiency((house == HOUSE_GOOD ? gdi_harvested : nod_harvested),
	                                              PlayerPtr->InitialCredits, PlayerPtr->Available_Money());
...
void DLLExportClass::Convert_Action_Type(ActionType type, ObjectClass* object, TARGET target,
                                         DllActionTypeEnum& dll_type)
{
	...
	case ACTION_SELF:
		...
		break;
	case ACTION_ATTACK:
		if (Target_Legal(target) && (object != NULL) && object->Is_Techno() && ((TechnoClass*)object)->
			In_Range(target, 0))
		{
			dll_type = DAT_ATTACK;
		}
...
**************************************************************************************************/
void DLLExportClass::On_Message(const HouseClass* player_ptr, const char* message, float timeout_seconds,
                                EventCallbackMessageEnum message_type, int64 message_id)
{
	if (EventCallback == NULL)
	{
...
**************************************************************************************************/
void DLLExportClass::On_Achievement(const HouseClass* player_ptr, const char* achievement_type,
                                    const char* achievement_reason)
{
	if (EventCallback == NULL)
	{
...
extern "C" __declspec(dllexport) bool __cdecl CNC_Get_Game_State(GameStateRequestEnum state_type, uint64 player_id,
                                                                 unsigned char* buffer_in, unsigned int buffer_size)
{
	//    DotNetApiVc::DebugBox("CNC_Get_Game_State start");
	//
	// DotNetApiVc::DebugBox((int)state_type);
	// DotNetApiVc::DebugBox((int)player_id);
	// DotNetApiVc::DebugBox((int)buffer_size);
	//
	// DotNetApiVc::DebugBox("CNC_Get_Game_State end");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Game_Request(GameRequestEnum request_type)
{
	// DotNetApiVc::DebugBox("CNC_Handle_Game_Request");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Game_Settings_Request(
	int health_bar_display_mode, int resource_bar_display_mode)
{
	// DotNetApiVc::DebugBox("CNC_Handle_Game_Settings_Request");
	...
	SpecialClass::eResourceBarDisplayMode new_rb_mode = (SpecialClass::eResourceBarDisplayMode)
		resource_bar_display_mode;
...
void DLL_Draw_Intercept(int shape_number, int x, int y, int width, int height, int flags, ObjectClass* object,
                        const char* shape_file_name = NULL, char override_owner = HOUSE_NONE, int scale = 0x100)
{
	DLLExportClass::DLL_Draw_Intercept(shape_number, x, y, width, height, flags, object, shape_file_name,
	                                   override_owner, scale);
}
		...
		for (int index = 0; index < Map.Layer[layer].Count(); index++)
		{
			...
			if (object->IsActive)
			{
				...
				if (object->Is_Techno())
				{
					...
					*/
					TechnoClass* techno_object = static_cast<TechnoClass*>(object);
					TechnoClass* contact_object = techno_object->In_Radio_Contact()
						                              ? techno_object->Contact_With_Whom()
						                              : nullptr;
					if ((contact_object != nullptr) && (contact_object->What_Am_I() == RTTI_BUILDING) && contact_object
						->IsTethered && *((BuildingClass*)contact_object) == STRUCT_WEAP)
					{
						continue;
					}
				}
				...
				if (Debug_Map || Debug_Unshroud || (object->IsDown && !object->IsInLimbo))
				{
					...
					*/
					for (int i = 1; i < CurrentDrawCount; ++i)
					{
						...
						if (((sub_object.DrawFlags & shadow_flags) == shadow_flags) || (strncmp(
							sub_object.AssetName, "WAKE", CNC_OBJECT_ASSET_NAME_LENGTH) == 0))
						{
								...
								(strncmp(sub_object.AssetName, "LROTOR", CNC_OBJECT_ASSET_NAME_LENGTH) != 0))
							{
								for (int j = i - 1; j >= 0; --j)
								{
									...
									if (!base_object.SubObject && (base_object.CNCInternalObjectPointer == sub_object.
                                                               ...
                                                               int x1, int y1, int x2, int y2)
{
	...
	// {
	// 	DotNetApiVc::DebugLine("CNC_Handle_Input");
	// 	DotNetApiVc::DebugLine((int)input_event);
	// 	DotNetApiVc::DebugLine((int)special_key_flags);
	// 	DotNetApiVc::DebugLine((int)player_id);
	// 	DotNetApiVc::DebugLine(x1);
	// 	DotNetApiVc::DebugLine(y1);
	// 	DotNetApiVc::DebugLine(x2);
	// 	DotNetApiVc::DebugLine(y2);
	// }
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Structure_Request(
	StructureRequestEnum request_type, uint64 player_id, int object_id)
{
	// DotNetApiVc::DebugBox("CNC_Handle_Structure_Request");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Unit_Request(UnitRequestEnum request_type, uint64 player_id)
{
	// DotNetApiVc::DebugBox("CNC_Handle_Unit_Request");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_SuperWeapon_Request(
	SuperWeaponRequestEnum request_type, uint64 player_id, int buildable_type, int buildable_id, int x1, int y1)
{
	// DotNetApiVc::DebugBox("CNC_Handle_SuperWeapon_Request");
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_ControlGroup_Request(
	ControlGroupRequestEnum request_type, uint64 player_id, unsigned char control_group_index)
{
	// DotNetApiVc::DebugBox("CNC_Handle_ControlGroup_Request");
...
bool DLLExportClass::Passes_Proximity_Check(CELL cell_in, BuildingTypeClass* placement_type,
                                            unsigned char* placement_distance)
{
	/*
...
* History: 1/29/2019 11:37AM - ST
**************************************************************************************************/
bool DLLExportClass::Construction_Action(SidebarRequestEnum construction_action, uint64 player_id, int buildable_type,
                                         int buildable_id)
{
	/*
	** 
							...
							*/
							...
							case SIDEBAR_REQUEST_HOLD_CONSTRUCTION:
								if (factory->Is_Building())
								{
									...
									OutList.Add(EventClass(EventClass::SUSPEND, (RTTIType)buildable_type,
									                       buildable_id));
								}
								break;
									...
									*/
									if (factory->Has_Completed())
									{
										...
										else
										{
											...
											if (!builder)
											{
												OutList.Add(EventClass(EventClass::ABANDON, (RTTIType)buildable_type,
												                       buildable_id));
												On_Speech(PlayerPtr, VOX_NO_FACTORY);
												//Speak(VOX_NO_FACTORY); // "Cannot Comply"
											}
											else
											{
												/*
									...
									else
									{
										...
										*/
										if (construction_action == SIDEBAR_REQUEST_START_CONSTRUCTION)
										{
											...
											OutList.Add(EventClass(EventClass::PRODUCE, (RTTIType)buildable_type,
											                       buildable_id));
											return true;
										}
									}
...
**************************************************************************************************/
bool DLLExportClass::MP_Construction_Action(SidebarRequestEnum construction_action, uint64 player_id,
...
bool DLLExportClass::Get_Shroud_State(uint64 player_id, unsigned char* buffer_in, unsigned int buffer_size)
{
	...
	unsigned int memory_needed = sizeof(*shroud) + 256;
	// Base amount needed. Will need more depending on how many entries there are
	...
	if (CurrentObject.Count() > 0)
	{
		...
		for (int i = 0; i < CurrentObject.Count(); ++i)
		{
			...
			if (object->Is_Techno())
			{
				...
				if (techno->Techno_Type_Class()->Primary != WEAPON_NONE || techno->Techno_Type_Class()->Secondary !=
					WEAPON_NONE)
				{
		...
		for (int y = top; y <= bottom; ++y)
		{
			for (int x = left; x <= right; ++x, ++index)
			{
				Convert_Action_Type(action_object->What_Action(XY_Cell(x, y)),
				                    (CurrentObject.Count() == 1) ? action_object : NULL, As_Target(XY_Cell(x, y)),
...
bool DLLExportClass::Get_Dynamic_Map_State(uint64 player_id, unsigned char* buffer_in, unsigned int buffer_size)
{
	...
	*/
	...
	unsigned int memory_needed = sizeof(*dynamic_map) + 256;
	// Base amount needed. Will need more depending on how many entries there are
...
**************************************************************************************************/
void DLLExportClass::Cell_Class_Draw_It(CNCDynamicMapStruct* dynamic_map, int& entry_index, CellClass* cell_ptr,
                                        int xpixel, int ypixel, bool debug_output)
{
	/*
	** 
	...
	*/
	if (cell_ptr->Overlay != OVERLAY_NONE)
	{
		...
		if (overlay_type.Get_Image_Data() != NULL)
		{
			...
			overlay_entry.DrawFlags = SHAPE_CENTER | SHAPE_WIN_REL | SHAPE_GHOST;
			// Looks like overlays are drawn centered and translucent
			...
			overlay_entry.IsResource = overlay_entry.Type >= OVERLAY_TIBERIUM1 && overlay_entry.Type <=
				OVERLAY_TIBERIUM12;
			overlay_entry.IsSellable = overlay_entry.Type >= OVERLAY_SANDBAG_WALL && overlay_entry.Type <=
				OVERLAY_WOOD_WALL;
	...
	*/
	...
	if (target != TARGET_NONE)
	{
		...
		if (building)
		{
			...
			{
				if (building && building->Can_Repair() && building->House && building->House->Class->House == PlayerPtr
				                                                                                              ->Class->
				                                                                                              House)
				{
					building->Repair(-1);
...
extern "C" __declspec(dllexport) void __cdecl CNC_Handle_Debug_Request(DebugRequestEnum debug_request_type,
                                                                       ...
                                                                       int y, bool unshroud, bool enemy)
{
	// DotNetApiVc::DebugBox("CNC_Handle_Debug_Request");
...
bool DLLExportClass::Try_Debug_Spawn_Unlimbo(TechnoClass* techno, int& cell_x, int& cell_y)
{
	if (techno)
	{
		...
		map_cell_right = min(map_cell_right, cell_x + 26);
		// Generally try to prevent the objects from spawing off the right of the screen
