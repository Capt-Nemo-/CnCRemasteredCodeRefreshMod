...
IntPtr KeyListener::SetHook(KeyboardProcedure^ proc)
{
...
void KeyListener::OnLowLevelKeyPress(Keys e)
{
	if (LowLevelKeyPress != nullptr)
		LowLevelKeyPress(this, gcnew KeyEventArgs(e));
}

bool KeyListener::Active::get()
{
	return _isActive;
}

void KeyListener::Active::set(bool value)
{
	_isActive = value;
}
